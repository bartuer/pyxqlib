...
CYTHON=cython
CYTHON_FLAGS=--cplus
# CFLAGS=-pthread -DNDEBUG -D_DEBUG  -fwrapv -g  -Wall -fstack-protector --param=ssp-buffer-size=4 -Wno-sign-compare -Wformat -Werror=format-security -D_FORTIFY_SOURCE=2 -fPIC
